...
contract SimpleBank {
    ...
    event LogWithdrawl(address indexed accountAddress, uint indexed withdrawAmount, uint indexed newBalance);
        ...
        returns (uint) 
    {
        ...
        require(enrolled[msg.sender], "Account must be Enrolled in the Bank.");
    ...
    function()
        external 
    {
        revert("Function Not Found or No Data Included");
    }
}
